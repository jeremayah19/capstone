                        ...
                        <div class="content-section" style="padding: 1.5rem; height: 100%;">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h6 style="color: var(--dark-pink); font-weight: 700; margin: 0;">
                                    <i class="fas fa-chart-area me-2"></i>6-Month Service Trends
                                </h6>
                                <div class="btn-group btn-group-sm" role="group">
                                    <button type="button" class="btn btn-outline-primary active" onclick="showTrendChart('combined')" style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">Both</button>
                                    <button type="button" class="btn btn-outline-primary" onclick="showTrendChart('consultations')" style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">Consult</button>
                                    <button type="button" class="btn btn-outline-primary" onclick="showTrendChart('appointments')" style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">Appt</button>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2" style="font-size: 0.85rem;">
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span><strong>Consultations:</strong> <?php echo array_sum(array_column($monthlyTrends, 'consultations')); ?></span>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        <div style="width: 15px; height: 15px; background: #667eea; border-radius: 2px; margin-right: 8px;"></div>
                                        <span><strong>Appointments:</strong> <?php echo array_sum(array_column($monthlyAppointments, 'appointments')); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
